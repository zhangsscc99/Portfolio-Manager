...
- **当前默认地址**: `http://103.146.124.206:5010/api`
...
# API配置
REACT_APP_API_URL=http://103.146.124.206:5010/api
```

### 2. 不同环境配置
- **生产环境**: `http://103.146.124.206:5010/api`
- **开发环境**: `http://103.146.124.206:5010/api`
- **测试环境**: 根据需要设置
